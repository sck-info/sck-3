...
export default function Hero() {
  ...
  useEffect(() => {
    ...
    return () =>
      window.removeEventListener("change-hero-template", handleTemplateChange);
  }, []);
  ...
  return (
    <section
      ...
      className={`relative overflow-hidden transition-all duration-500 ${
        isTemplate2
          ? "bg-[#090A0F] text-paper pt-28 pb-16 sm:pt-32 sm:pb-24 md:min-h-[calc(100vh-80px)] flex items-center justify-center"
          : "bg-aura text-ink pt-28 pb-24 sm:pt-32 sm:pb-32"
      }`}
    >
      <AnimatePresence>
        {isTemplate2 && (
      ...
      <HangingLotus
        align="right"
        offset="right-36 sm:right-56"
        className="top-24 opacity-30 scale-[0.6]"
      />
      ...
      <Container className="relative z-10 w-full">
        ...
        >
          ...
          >
            <div>
              <div
                className={`inline-flex items-center gap-2 px-3.5 py-1.5 border rounded-none mb-4 ${
                  isTemplate2
                    ? "bg-paper/10 border-paper/20"
                    : "bg-stone-light/60 border-stone"
                }`}
              >
                <span
                  className="text-clay text-xs select-none"
                  aria-hidden="true"
                >
                  &#10047;
                </span>
                <span
                  className={`text-[10px] font-mono tracking-[0.25em] font-bold uppercase ${
              ...
              <h1
                className={`font-display text-4xl sm:text-6xl font-light tracking-tight leading-[1.08] ${
              ...
              <p
                className={`mt-4 font-serif italic text-sm tracking-wider border-l pl-4 py-1.5 max-w-xl ${
                  isTemplate2
                    ? "text-paper/90 bg-paper/5 border-gold/60 mx-auto lg:mx-0"
                    : "text-ink-soft bg-stone-light/40 border-clay/60 mx-auto lg:mx-0"
                }`}
              >
                <span className="font-hindi not-italic font-normal block mb-1 text-base sm:text-lg">
                  &ldquo;असतो मा सद्गमय &bull; तमसो मा ज्योतिर्गमय &bull;
                  मृत्योर्मा अमृतं गमय&rdquo;
                </span>
                <span
                  className={`text-xs sm:text-sm font-sans tracking-wide block mt-1 not-italic ${
                    isTemplate2 ? "text-paper/80" : "text-ink-soft/80"
                  }`}
                >
                  Lead me from ignorance to truth, from darkness to light, from
            ...
            <div className="max-w-xl w-full">
              ...
              >
                ...
                &amp; Breath Expert, Holistic Wellness Coach &amp; Professional
                Singer. Inspiring 1.5 lakh+ lives across 10+ countries.
              </p>
            </div>

            <div
              className={`w-full max-w-xl border p-5.5 rounded-none shadow-sm relative overflow-hidden mx-auto lg:mx-0 transition-colors ${
                isTemplate2
              ...
              <div className="flex items-center gap-5 relative z-10 text-left">
                      ...
                      breathState === "Inhale"
                        ...
                        : breathState === "Hold"
                          ...
                          : breathState === "Exhale"
                            ...
                            : isTemplate2
                              ? "bg-paper/10 border-paper/30"
                              : "bg-stone-light border-stone"
                    }`}
                  >
                    <span
                      className={`text-sm font-mono font-bold ${isTemplate2 ? "text-paper" : "text-ink"}`}
                    >
                      {breathCount}s
                    </span>
                  </motion.div>
                ...
                <div>
                  ...
                  <AnimatePresence mode="wait">
                    ...
                    >
                      {breathState === "Inhale" &&
                        "Breath In: Draw in quiet energy..."}
                      {breathState === "Hold" &&
                        "Hold: Suspend and feel the peace..."}
                      {breathState === "Exhale" &&
                        "Breath Out: Let go of all strain..."}
                      {breathState === "HoldAgain" &&
                        "Hold Again: Rest in the empty space..."}
                    </motion.p>
                  </AnimatePresence>
                  <p
                    className={`text-xs sm:text-sm leading-normal font-light mt-1 ${
                      isTemplate2 ? "text-paper/80" : "text-ink-soft/90"
                    }`}
                  >
                    Take a moment to align with this pattern before exploring my
                    offerings.
                  </p>
                </div>
              </div>
